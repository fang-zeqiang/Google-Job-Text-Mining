...
for d in datas:
    t=[lemmatizer.lemmatize(x.lower()) for x in re.sub(pattern,' ', d["Preferred Qualifications"]).split()]
    words_each.append(t)
    words+=t
...
wordcloud.add("优先条件", n, v, word_size_range=[40, 200])
wordcloud.render("优先条件词云.html")
